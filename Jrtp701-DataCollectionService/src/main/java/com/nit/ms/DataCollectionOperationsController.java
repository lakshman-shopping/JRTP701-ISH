...
public class DataCollectionOperationsController {
	...
	public  ResponseEntity<List<String>> displayPlanNames(){
	    ...
	    public ResponseEntity<Integer>  savePlanSelections(@RequestBody PlanSelectionInputs inputs){
	    	//useService
	    	Integer caseNo = dcService.savePlanSelection(inputs);
	    	return new ResponseEntity<Integer>(caseNo,HttpStatus.OK);
	    }
	    @PostMapping("/saveIncome")
	    public  ResponseEntity<Integer>  showIncomeDetails(@RequestBody IncomeInputs income){
	    	//use service
	    ...
	    public ResponseEntity<Integer>  saveChildrenDetails(@RequestBody  List<ChildrenInputs> childs){
	    	//use service
